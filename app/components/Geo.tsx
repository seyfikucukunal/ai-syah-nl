    ...
    <section id="geo" className="px-6 py-24">
      <div className="mx-auto max-w-5xl text-center">
        ...
        <h2 className="mb-6 text-4xl font-bold md:text-5xl">
          Zoekmachines veranderen. AI-zoekmachines worden het nieuwe startpunt.
        </h2>
        <p className="mx-auto max-w-3xl text-lg leading-relaxed text-zinc-400">
          Mensen zoeken steeds vaker via AI-systemen zoals ChatGPT, Gemini, Claude en Perplexity. AI-syah helpt bedrijven om niet alleen gevonden te worden in Google, maar ook genoemd, begrepen en aanbevolen te worden door AI-zoekmachines.
        </p>
