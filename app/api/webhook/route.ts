...
async function generateAndSendReport(url: string, email: string) {
  ...
  console.log(`Rapport verstuurd naar ${email}`);
}
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    // waitUntil zorgt dat Vercel de functie niet stopt na de response
    waitUntil(generateAndSendReport(url, email));
